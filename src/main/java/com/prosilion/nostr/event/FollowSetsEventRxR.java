...
@Getter
public class FollowSetsEventRxR extends AddressableEvent implements TagMappedEventIF {
  ...
  @JsonIgnore
  private final List<BadgeAwardGenericEventAux<BadgeDefinitionGenericEventAux>> badgeAwardGenericEvents; // eTags
  @JsonIgnore
  private final BadgeDefinitionReputationEvent badgeDefinitionReputationEvent; // aTag

  public FollowSetsEventRxR(
     @NonNull Identity identity,
     @NonNull BadgeDefinitionReputationEvent badgeDefinitionReputationEvent,
     @NonNull Relay relay,
     @NonNull BadgeAwardGenericEventAux<BadgeDefinitionGenericEventAux> badgeAwardGenericEvents) {
  ...
  public FollowSetsEventRxR(
     ...
     @NonNull BadgeDefinitionReputationEvent badgeDefinitionReputationEvent,
     @NonNull Relay relay,
     @NonNull List<BadgeAwardGenericEventAux<BadgeDefinitionGenericEventAux>> badgeAwardGenericEvents) {
          ...
          Stream.concat(
             Stream.concat(
                TagMappedEventIF.throwIfEmpty(
                   ...
                   .map(FollowSetsEventRxR::badgeAwardGenericEventAsEventTag),
                Stream.of(
  ...
  public static PubKeyTag validateIdenticalBadgeAwardGenericEventsPublicKeys(@NonNull List<BadgeAwardGenericEventAux<BadgeDefinitionGenericEventAux>> badgeAwardGenericEvents) {
