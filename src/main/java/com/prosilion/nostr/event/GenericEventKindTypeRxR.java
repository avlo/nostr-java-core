...
@Slf4j
public record GenericEventKindTypeRxR(
    @NonNull @JsonIgnore GenericEventRecordRxR genericEventKind,
    @NonNull @Getter @EqualsAndHashCode.Exclude @JsonIgnore KindTypeIF kindType) implements EventRxRIF {
