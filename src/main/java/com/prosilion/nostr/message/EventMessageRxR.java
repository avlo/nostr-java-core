...
import com.prosilion.nostr.codec.deserializer.EventMessageDeserializerRxR;
import com.prosilion.nostr.codec.serializer.EventMessageSerializerRxR;
...
@JsonSerialize(using = EventMessageSerializerRxR.class)
@JsonDeserialize(using = EventMessageDeserializerRxR.class)
public record EventMessageRxR(
    @Getter @JsonPropertyDescription("EVENT") EventRxRIF event,
  ...
  public EventMessageRxR(@JsonProperty EventRxRIF event) {
    this(event, null);
  }

  public EventMessageRxR(@JsonProperty EventRxRIF event, @Nullable String subscriptionId) {
    this.event = event;
  ...
  public static BaseMessage decode(@NonNull String json) throws JsonProcessingException {
    return ENCODER_MAPPED_AFTERBURNER.readValue(json, EventMessageRxR.class);
  }
