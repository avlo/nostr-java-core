...
//import com.prosilion.nostr.tag.RelayTagAux;
...
//       badgeDefnUpvoteEvent, new RelayTagAux(relay));
//
...
//       new BadgeDefinitionGenericEvent(authorIdentity, upvoteIdentifierTag, relay), new RelayTagAux(relay));
//
