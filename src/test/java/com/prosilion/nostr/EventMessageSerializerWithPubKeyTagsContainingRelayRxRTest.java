...
//@Slf4j
//@ActiveProfiles("test")
//public class EventMessageSerializerWithPubKeyTagsContainingRelayRxRTest {
...
//  private final BadgeAwardGenericEventAux<BadgeDefinitionGenericEventAux> badgeAwardGenericEventWithAddressTagAux;
//
...
//
//  public EventMessageSerializerWithPubKeyTagsContainingRelayRxRTest() throws ParseException {
//
//    BadgeDefinitionGenericEvent badgeDefnUpvoteEvent = new BadgeDefinitionGenericEvent(platformIdentity, upvoteIdentifierTag, relay);
//
//    this.badgeDefnUpvoteEventAux = new BadgeDefinitionGenericEventAux(
//       badgeDefnUpvoteEvent, new RelayTag(relay));
//
//    this.badgeAwardGenericEventWithAddressTagAux = new BadgeAwardGenericEventAux<>(
//       platformIdentity,
...
//       new BadgeDefinitionGenericEvent(authorIdentity, upvoteIdentifierTag, relay), new RelayTag(relay));
//
...
//       relay,
//       List.of(badgeAwardUpvoteEventAux));
//  }
//
//  @Test
