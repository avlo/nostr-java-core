...
public class EventMessageSerializerTest {
  ...
  @Test
  void testEventMessageWithSubscriberIdEncoderAddressTagWithRelay() throws IOException, NostrException {
    EventMessage eventMessageContainingSubscriberId = new EventMessage(
      new GenericEventRecord(
        "5f66a36101d3d152c6270e18f5622d1f8bce4ac5da9ab62d7c3cc0006e590001",
        new PublicKey("bbbd79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984"),
    ...
    checkWithoutExplicitJson(eventMessageContainingSubscriberId);
    checkWithExplicitJson(eventMessageContainingSubscriberId, explicitJsonNoSubscriberIdEncoderWithAddressTag());
  }
  ...
  @Test
  void testEventMessageWithGenericRecord() throws IOException, NostrException {
    Identity identity = Identity.generateRandomIdentity();
    GenericEventRecord genericEventRecord1 = new GenericEventRecord(
      "5f66a36101d3d152c6270e18f5622d1f8bce4ac5da9ab62d7c3cc0006e590001",
      new PublicKey("bbbd79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984"),
      1111111111111L,
      Kind.BADGE_AWARD_EVENT,
...
//
  ...
  private String explicitJsonNoSubscriberIdEncoderWithAddressTag() {
    return "[\"EVENT\",{\"id\":\"5f66a36101d3d152c6270e18f5622d1f8bce4ac5da9ab62d7c3cc0006e590001\",\"pubkey\":\"bbbd79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984\",\"created_at\":1111111111111,\"kind\":8,\"tags\":[[\"a\",\"30009:bbbd79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984:upvote\",\"ws://localhost:5555\"]],\"content\":\"matching kind, author, identity-tag filter test\",\"sig\":\"86f25c161fec51b9e441bdb2c09095d5f8b92fdce66cb80d9ef09fad6ce53eaa14c5e16787c42f5404905536e43ebec0e463aee819378a4acbe412c533e60546\"}]";
  }
}
