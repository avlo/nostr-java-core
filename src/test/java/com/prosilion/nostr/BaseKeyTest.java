...
class BaseKeyTest {
  ...
  public void testInValidNullPublicKeyString() {
    ...
    assertThrows(NostrException.class, () -> new PublicKey(""));
  }

  @Test
  public void testInValidPublicKeyNonHexDigits() {
    System.out.println("testInValidPublicKeyNonHexDigits");
    assertThrows(NostrException.class, () -> new PublicKey(INVALID_HEXPUBKEY_NON_HEX_DIGITS));
  }

  @Test
  public void testInValidPublicKeyLengthTooShort() {
    System.out.println("testInValidPublicKeyLengthTooShort");
    assertThrows(NostrException.class, () -> new PublicKey(INVALID_HEXPUBKEY_LENGTH_TOO_SHORT));
  }

  @Test
  public void testInValidPublicKeyLengthTooLong() {
    System.out.println("testInValidPublicKeyLengthTooShort");
    assertThrows(NostrException.class, () -> new PublicKey(INVALID_HEXPUBKEY_LENGTH_TOO_LONG));
  }
  ...
  public void testInvalidPublicKeyMultipleUppercase() {
    ...
    assertThrows(NostrException.class, () -> new PublicKey(INVALID_HEXPUBKEY_HAS_MULTIPLE_UPPERCASE));
  }

  @Test
  public void testInvalidPublicKeySingleUppercase() {
    System.out.println("testInvalidPublicKeySingleUppercase");
    assertThrows(NostrException.class, () -> new PublicKey(INVALID_HEXPUBKEY_HAS_SINGLE_UPPERCASE));
  }
}
